...
// No package-pick zoom beat — package choice already happens inline below
// (per Franz's 2026-07-22 call, the separate zoom was redundant). Payment
// flow (real Credit/Company Card options alongside the joke ones, a
// processing spinner, then a corner "submit your briefing" CTA) added the
// same day per Daniel's batch.
